...
| 파일 | 내용 |
|---|---|
| `docs/pitch.html` | **대표 보고용 제안서** — 9개 질문으로 이어지는 설득 구조, 승인 요청 3가지 |
| `docs/master-report.html` | **사업 전략 종합 보고서** — 시장 진단, 산업 구조, 화학적 상용성 분석, 데이터 구축 전략, 비대면 사업 모델, 2인 팀 로드맵 (13개 장, 참고문헌 130건) |
| `docs/data-collection-protocol.md` | 경험 데이터 인출 프로토콜 — 정리된 자료 없이 초기 데이터셋을 구축하는 절차 |
| `tools/compat-db.html` | 상용성 데이터베이스 — 납품·클레임 이력 입력, 수지×제형 위험도 매트릭스, 사전 진단 |
| `tools/basket-analysis.html` | 거래 조합 분석 — 거래명세서 CSV에서 함께 구매된 품목 조합·묶음 후보·성장 고객 발굴 |
